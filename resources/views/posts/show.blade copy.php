...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">{{ __('comments.aaaaaa') }}</div>
                    <div class="card-body">
                    ...
                    @auth
                        <form method="POST" action="{{ route('posts.comments.store', $post->slug) }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description" maxlength="1500" class="form-control @error('description') is-invalid @enderror" name="description">{{ old('description') }}</textarea>
                                    @error('description')
