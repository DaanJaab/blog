...
@endif
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Dodawanie posta w dziale') . ' ' . $category->name }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('blog.posts.store', $category->id) }}" {{-- enctype="multipart/form-data" --}}>
                        @csrf
                        <div class="row mb-3">
