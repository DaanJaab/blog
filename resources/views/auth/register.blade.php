            ...
            <div class="wrapper wrapper-content animated fadeInRight">
                <div class="ibox-content m-b-sm border-bottom">
                    <div class="p-xs">
                        ...
                        <h2>
                            <a href="{{ route('blog.index') }}">{{ __('global.blog_page') }}</a> -&rsaquo; {{ __('auth.registration') }}
                        </h2>
                        <span>{{ __('auth.registration_desc') }}</span>
                    </div>
                </div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message . ' ' . __('auth.forgot_password') }} <a href="{{ route('password.request') }}">{{ __('auth.forgot_password_reset') }}</a></strong>
                                        </span>
                                    @enderror
                                </div>
                            </div>
